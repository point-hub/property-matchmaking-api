...
describe('retrieve all land titles', async () => {
  let app: Express;
  ...
  it('S.1. succeeds', async () => {
    ...
    await landTitleFactory.createMany(3);
    ...
    expect(response.body.data[0].name).toStrictEqual(landTitles.data[0].name);
    expect(isValidDate(response.body.data[0].created_at)).toBeTruthy();
    expect(response.body.data[1].name).toStrictEqual(landTitles.data[1].name);
    expect(response.body.data[2].name).toStrictEqual(landTitles.data[2].name);
  ...
  it('S.2. succeeds in sorting data in ascending order', async () => {
    ...
    landTitleFactory.sequence(data);
    await landTitleFactory.createMany(3);
  ...
  it('S.4. succeeds in navigating pagination', async () => {
    ...
    expect(response.body.data[0].name).toStrictEqual(landTitles.data[2].name);
